        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <PhoneInput id="organizer_phone" value={form.organizer_phone} onChange={(value) => updateField('organizer_phone', value)} className="w-full px-3 py-2.5 rounded-lg border border-gray-200 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1E3A5F]/30" />
            </div>
          </div>
        </section>
