...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('Failed to fetch content refresh suggestions', { error })
    return NextResponse.json(
      { error: 'Failed to fetch content refresh suggestions' },
      { status: 500 }
    )
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error('Failed to update content refresh suggestion', { error })
    return NextResponse.json(
      { error: 'Failed to update content refresh suggestion' },
      { status: 500 }
    )
  }
}
