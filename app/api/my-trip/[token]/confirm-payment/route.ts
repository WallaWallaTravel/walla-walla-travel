 ...
 * Confirm payment after Stripe redirect and mark deposit as paid (client-facing via access token).
 */
...
export const POST = withErrorHandling<unknown, RouteParams>(
  async (request: NextRequest, context) => {
    ...
    after(async () => {
      try {
        logger.info('[My Trip Payment] Payment confirmed', {
        ...
        logger.error('[My Trip Payment] Failed to send deposit received email', {
