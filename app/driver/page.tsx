      ...
      <div className="bg-white rounded-lg shadow-soft overflow-hidden border border-slate-200 hover:shadow-medium transition-shadow">
        <div className="flex items-stretch">
          ...
          <div className="flex flex-col border-l border-slate-200">
            ...
            <button
              onClick={() => router.push(`/driver/tour/${tour.booking_id}`)}
    ...
    <div className="bg-white rounded-lg shadow-soft overflow-hidden border border-slate-200">
      ...
      <div className="p-6 bg-gray-50 border-b border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            <div className="text-xs font-medium text-navy-600 mb-1 uppercase tracking-wider">📍 Pickup Location</div>
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            <div className="text-xs font-medium text-navy-600 mb-1 uppercase tracking-wider">🏁 Dropoff Location</div>
      ...
      {tour.driver_notes && (
        <div className="p-6 bg-amber-50 border-b border-amber-200">
          <div className="text-sm font-bold text-amber-700 mb-2 uppercase tracking-wider">⚠️ Important Notes</div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">{stop.winery_name}</h3>
                  <div className="text-base font-semibold text-navy-700 mb-1">
                    {formatTime(stop.arrival_time)} → {formatTime(stop.departure_time)}
                    <span className="text-gray-500 text-sm ml-3">({stop.duration_minutes} min)</span>
                  </div>
