...
Next steps:
  1. Login at: https://walla-walla-travel.up.railway.app/login
  2. Email: madsry@gmail.com
  3. Go to: https://walla-walla-travel.up.railway.app/admin/dashboard
```
...
### 1. Test Admin Access
```bash
open https://walla-walla-travel.up.railway.app/login
```
...
```bash
open https://walla-walla-travel.up.railway.app/admin/dashboard
```
