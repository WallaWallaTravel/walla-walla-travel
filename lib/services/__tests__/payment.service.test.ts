...
describe('PaymentService', () => {
  ...
  describe('createPayment', () => {
    ...
    it('should reject zero amount payments', async () => {
      // Zero amount payments are no longer allowed (must be positive)
      // Free bookings should use 'comp' payment method with amount > 0
      // or be handled through a different flow
    ...
    it('should accept small positive amounts (minimum valid payment)', async () => {
      const mockPayment = createMockPayment({ amount: 0.01 });
  ...
  // ============================================================================
  // Schema Boundary Tests (Critical for Payment Security)
  // ============================================================================

  describe('payment amount boundary validation', () => {
    ...
    it('should reject exactly zero amounts', () => {
      const result = CreatePaymentSchema.safeParse({
        customerId: 1,
        amount: 0,
        paymentMethod: 'card',
    ...
    it('should accept large amounts up to reasonable limits', () => {
      const result = CreatePaymentSchema.safeParse({
        customerId: 1,
        amount: 999999.99, // ~$1M
        paymentMethod: 'wire',
    ...
    it('should reject zero customerId', () => {
      const result = CreatePaymentSchema.safeParse({
        customerId: 0,
        amount: 100,
        paymentMethod: 'card',
    ...
    it('should reject non-integer customerId', () => {
      const result = CreatePaymentSchema.safeParse({
        customerId: 1.5,
        amount: 100,
        paymentMethod: 'card',
    ...
    it('should reject negative bookingId', () => {
      const result = CreatePaymentSchema.safeParse({
        customerId: 1,
        bookingId: -1,
        amount: 100,
    ...
    it('should reject negative reservationId', () => {
      const result = CreatePaymentSchema.safeParse({
        customerId: 1,
        reservationId: -1,
        amount: 100,
  ...
  describe('stripe payment intent handling', () => {
    it('should store stripe payment intent ID when provided', async () => {
      const stripeIntentId = 'pi_3N9jKlJEv5uTVQN71Dj4XWkm';
      const mockPayment = createMockPayment({
      ...
      expect(result.stripe_payment_intent_id).toBe(stripeIntentId);
      expect(result.payment_status).toBe('completed');
    });

    it('should set pending status when no stripe intent provided', async () => {
      const mockPayment = createMockPayment({
        stripe_payment_intent_id: null,
        payment_status: 'pending',
      });
